...
* Commit often!
  * COMMIT YOUR TESTS FIRST! 
  * We will check for TDD via your git history.
...
- Bonus points if you use a **stub** to test the `announce_lottery_winner` method in conjunction with the `draw_lottery_winner` method. JOY!
